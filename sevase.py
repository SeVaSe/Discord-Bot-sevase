...
PREFIX = '.'
bad_words=['хуй', 'слава украине', 'свинья', 'блядь', 'шлюха', 'мразь', 'хуйло', 'мразь', 'хуесос', 'россия топ', 'Россия топ', 'Украина топ', 'бандера', 'бомж', 'мать шлюха', 'мать', 'ебал', 'ебал твою мать',
           'мать', 'ебал мать', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '',
            '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '',
            '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '',
            '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '',
